    ...
    return (
        <motion.header
            className={`fixed top-6 left-1/2 -translate-x-1/2 z-50 transition-all duration-500 ease-out flex items-center justify-between px-8 rounded-full h-[88px] w-[calc(100%-48px)] max-w-[1280px] ${
                scrolled ? 'bg-[var(--color-surface)]/80 backdrop-blur-md border border-[var(--color-border-soft)] shadow-[0_20px_60px_rgba(0,0,0,0.06)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.4)]' : 'bg-transparent'
            }`}
